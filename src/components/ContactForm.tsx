    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-xl">
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-3 rounded-lg border border-white/10 bg-[#111] text-white placeholder-stone-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all"
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-4 py-3 rounded-lg border border-white/10 bg-[#111] text-white placeholder-stone-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all resize-none"
